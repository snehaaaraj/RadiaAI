...
def overall_from_statuses(statuses: list[ReviewStatus]) -> ReviewStatus:
    ...
    Priority order:
    1. UNACCEPTABLE â€” if any status is UNACCEPTABLE, the overall is UNACCEPTABLE
    2. REVISION_RECOMMENDED â€” if any status is REVISION_RECOMMENDED, the overall is REVISION_RECOMMENDED
    3. ACCEPTABLE â€” only if all statuses are ACCEPTABLE
    """
